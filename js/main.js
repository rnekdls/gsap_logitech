window.addEventListener("DOMContentLoaded", function () {
  ...
  $(".cursor_effect")
    ...
    .mouseleave(function () {
      gsap.to(".dot", { scale: 0.15, background: "#4272ff" });
    });
  ...
  gsap.to(".fix-this-1", {
    scrollTrigger: {
      ...
      // markers: true, // 페이지상에 'start'와 'end'를 표시해준다. (불필요한 경우 주석처리)
    },
  });
  ...
  const video05 = this.document.querySelector("#sc05_video");
  gsap.to("#section05", {
    scrollTrigger: {
      trigger: "#section05",
      start: "4500 top",
  ...
  // section 6 화면 위치할 때 글자 slide-up
  gsap.to("#section06", {
    scrollTrigger: {
      trigger: "#section06",
      start: "top top",
  ...
  // section 06 headset image move animation
